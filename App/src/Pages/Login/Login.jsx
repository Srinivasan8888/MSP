...
import xyma from "../../Images/Xyma-Logo.png";
            ...
            <img className="w-32 h-auto mr-2" src={xyma} alt="logo" />
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={Loginuser}>
                ...
                <button
                  ...
                  type="submit"
                  className="w-full text-white bg-[#3b82f6] hover:bg-[#1d4ed8] focus:ring-4 focus:outline-none focus:ring-[#93c5fd] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#2563eb] dark:hover:bg-[#1d4ed8] dark:focus:ring-[#1e3a8a]"
