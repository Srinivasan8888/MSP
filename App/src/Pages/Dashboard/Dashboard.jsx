    ...
    <DashboardProvider>
      <div className="h-screen overflow-x-scroll bg-[rgba(17,25,67,1)] p-2">
        <div className="xl:h-[50%] flex flex-col xl:flex-row  ">
          ...
          <div className="text-white xl:h-[95%] xl:w-[40%] h-full  bg-white/5 border border-gray-400 rounded-2xl m-2 flex flex-col items-center">
            <LineGraphProvider>
              <Dropdown />
              <LineGraph />
            </LineGraphProvider>
        ...
        <div className="xl:h-[50%] flex flex-col xl:flex-row bg-[rgba(17,25,67,1)]">
          <div className="h-[800px] xl:h-[75%] 2xl:h-[83%] xl:w-[60%] text-black overflow-x-auto overflow-y-auto pl-2 mt-2 pr-3 xl:pr-4.5 mx-auto">
            <Table />
          </div>
